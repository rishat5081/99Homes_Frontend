...
const ListingForm = () => {
  ...
  const submitHandler = async (e) => {
    ...
    fd.append("purpose", purposeData);
    fd.append("city", cityData);
    fd.append("location", locationData);
    fd.append("area", areaData);
    fd.append("areaUnit", unittypeData);
    fd.append("rooms", roomData);
    fd.append("bath", bathData);
    fd.append("garage", garageData);
    fd.append("portion", portionData);
    fd.append("category", catogaryData);
    fd.append("numb_of_floors", floorData);
    fd.append("price", priceData);
    fd.append("priceUnit", priceUnitData);
    fd.append("isFurnished", checkboxData);
    fd.append("kitchen", kichanData);
    fd.append("type", typeData);
    fd.append("discription", descriptionData);
    fd.append("images", fileData);
    try {
      setloading(true);
      await axios.post("/add_property", fd);
